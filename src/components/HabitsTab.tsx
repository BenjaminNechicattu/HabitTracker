  ...
  return (
    <View style={styles.tabBody}>
      <View style={[styles.sectionCard, { backgroundColor: palette.card, borderColor: palette.border }]}> 
          ...
          const iconName = getHabitIconName(habit.category);
            const progressLabel =
              ...
              : habit.reminderEnabled
                ...
                : 'No reminder';
          return (
            <View key={habit.id} style={[styles.habitStackRow, { borderBottomColor: palette.border }]}> 
        ...
        {filteredHabits.length === 0 ? <Text style={[styles.habitInfo, { color: palette.muted }]}>No habits in this filter.</Text> : null}
      </View>
    </View>
  );
}
